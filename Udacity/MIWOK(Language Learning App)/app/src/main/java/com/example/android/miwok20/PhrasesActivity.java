...
public class PhrasesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phrases.add(new Word("My name is...", "oyaaset...", R.raw.phrase_what_is_your_name));
        phrases.add(new Word("How are you feeling?", "michәksәs?", R.raw.phrase_what_is_your_name));
